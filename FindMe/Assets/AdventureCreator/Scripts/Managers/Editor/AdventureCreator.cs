			...
			if (Resource.References)
			{
				...
				if (showScene)
				{
					...
					if (KickStarter.sceneSettings && KickStarter.sceneSettings.requiredManagerPackage && KickStarter.sceneSettings.requiredManagerPackage.sceneManager)
					{
						...
						KickStarter.sceneManager.ShowGUI (this.position, ActionListEditorWindow.Init, ActionListEditorWindow.Init);
					...
					else
					{
						...
						{
							scroll = GUILayout.BeginScrollView (scroll);
							Resource.References.sceneManager.ShowGUI (this.position, ActionListEditorWindow.Init, ActionListEditorWindow.Init);
							GUILayout.EndScrollView ();
						}
					}
				}
				...
				else if (showSettings)
				{
					...
					if (KickStarter.sceneSettings && KickStarter.sceneSettings.requiredManagerPackage && KickStarter.sceneSettings.requiredManagerPackage.settingsManager)
					{
						...
						scroll = GUILayout.BeginScrollView (scroll);
						KickStarter.settingsManager.ShowGUI (ActionListEditorWindow.Init);
						GUILayout.EndScrollView ();
					}
					else
					{
						...
						{
							scroll = GUILayout.BeginScrollView (scroll);
							Resource.References.settingsManager.ShowGUI (ActionListEditorWindow.Init);
							GUILayout.EndScrollView ();
						}
					}
				}
				...
				else if (showInvItems)
				{
					...
					if (KickStarter.sceneSettings && KickStarter.sceneSettings.requiredManagerPackage && KickStarter.sceneSettings.requiredManagerPackage.inventoryManager)
					{
						...
						scroll = GUILayout.BeginScrollView (scroll);
						KickStarter.inventoryManager.ShowGUI (this.position, ActionListEditorWindow.Init);
						GUILayout.EndScrollView ();
					}
					else
					{
						...
						{
							scroll = GUILayout.BeginScrollView (scroll);
							Resource.References.inventoryManager.ShowGUI (this.position, ActionListEditorWindow.Init);
							GUILayout.EndScrollView ();
						}
					}
				}
				...
				else if (showCursor)
				{
					...
					if (KickStarter.sceneSettings && KickStarter.sceneSettings.requiredManagerPackage && KickStarter.sceneSettings.requiredManagerPackage.cursorManager)
					{
						...
						scroll = GUILayout.BeginScrollView (scroll);
						KickStarter.cursorManager.ShowGUI (ActionListEditorWindow.Init);
						GUILayout.EndScrollView ();
					}
					else
					{
						...
						{
							scroll = GUILayout.BeginScrollView (scroll);
							Resource.References.cursorManager.ShowGUI (ActionListEditorWindow.Init);
							GUILayout.EndScrollView ();
						}
					}
				}
				...
				else if (showMenu)
				{
					...
					if (KickStarter.sceneSettings && KickStarter.sceneSettings.requiredManagerPackage && KickStarter.sceneSettings.requiredManagerPackage.menuManager)
					{
						...
						scroll = GUILayout.BeginScrollView (scroll);
						KickStarter.menuManager.ShowGUI (ActionListEditorWindow.Init);
						GUILayout.EndScrollView ();
					}
					else
					{
						...
						{
							scroll = GUILayout.BeginScrollView (scroll);
							Resource.References.menuManager.ShowGUI (ActionListEditorWindow.Init);
							GUILayout.EndScrollView ();
						}
					}
				}
