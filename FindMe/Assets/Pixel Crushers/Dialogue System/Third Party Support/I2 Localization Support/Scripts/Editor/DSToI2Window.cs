...
namespace PixelCrushers.DialogueSystem.I2Support
{
    ...
    public class DSToI2Window : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            prefs.copyEmptyValuesToI2 = EditorGUILayout.Toggle(new GUIContent("Copy Empty Values", "Copy empty values to i2 terms."), prefs.copyEmptyValuesToI2);
        ...
        {
            if (string.IsNullOrEmpty(value) && !prefs.copyEmptyValuesToI2) return;
        ...
        private void AddTranslation(string term, string language, int languageIndex, string value)
        {
            if (string.IsNullOrEmpty(term) ||
                (string.IsNullOrEmpty(value) && !prefs.copyEmptyValuesToI2) ||
