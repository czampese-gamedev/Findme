...
namespace AC
{
	...
	public class ActionDialogueSystemLua : Action
	{
		...
		[LuaScriptWizard] public string luaCode = string.Empty;
		...
		public override string Title { get { return "Dialogue System Lua"; } }
		public override string Description { get { return "Runs Lua code in the Dialogue System's Lua environment."; } }
        ...
        override public void ShowGUI(List<ActionParameter> parameters)
        {
            ...
            else
            {
				...
				EditorGUILayout.PropertyField(serializedObject.FindProperty("luaCode"));
				serializedObject.ApplyModifiedProperties();
                //---Was: luaCode = EditorGUILayout.TextField(new GUIContent("Lua Code:", "The Lua code to run"), luaCode);
            }
